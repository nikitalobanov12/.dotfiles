return {
  {
    ...
    config = function()
      ...
      -- Keymaps to replace your tmux setup
      ...
      vim.keymap.set('n', '<leader>or', function() require('opencode').prompt('Review @selection for potential improvements') end, { desc = 'Review selection' })
    end,
  },
}